...
public final class AtomAPI {
    ...
    @Getter
    private static org.shotrush.atom.core.storage.DataStorage dataStorage;
    
    @Getter
    private static org.shotrush.atom.core.age.AgeManager ageManager;
    
    @Getter
    private static org.shotrush.atom.core.items.CustomItemRegistry itemRegistry;
    
    @Getter
    private static org.shotrush.atom.core.blocks.CustomBlockManager blockManager;
